...
document.getElementById('validateNews3').addEventListener('submit', function (event) {
    event.preventDefault();

    let emailNews = document.getElementById("emailNews3");
    let nameNews = document.getElementById('nameNews3')
