...
document.getElementById('validateNews2').addEventListener('submit', function (event) {
    event.preventDefault();

    let emailNews = document.getElementById("emailNews2");
    let nameNews = document.getElementById('nameNews2')
